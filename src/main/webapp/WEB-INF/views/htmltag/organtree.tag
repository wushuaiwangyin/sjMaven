...
<div class="clearfix ${class} input-group" style="${style}">
	...
	<span class="input-group-btn">
		...
		data-mode="page" data-url="${ctxPath}/tag/organtree"
		data-data="{url:'${url}',id:'${id}',nameId:'${nameId}',pIdKey:'${pIdKey}',selectIds:'${selectIds}',curId:'${curId}',checked:'${checked}',rootNodeName:'${rootNodeName}',isLayer:'${isLayer}',level:'${level}'}" 
