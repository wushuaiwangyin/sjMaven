...
public class ModelApproveController extends BaseController {
	...
	* @return
	...
	public String deal(@RequestParam(value = "ids[]") Long[] ids,Model model){
		...
		return BASE_PATH + "/model-flow-deal-approve";
	}
	...
	* @return
	...
	public void exportFile(@RequestParam Map<String, Object> params,
		...
		try {
			//流的方式直接下载
			ExcelUtils.exportExcel(response, "待审批模型.xls", list, titleMap);
