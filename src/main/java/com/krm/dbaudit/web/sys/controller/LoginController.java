...
import com.krm.dbaudit.web.sys.service.SysResourceService;
import com.krm.dbaudit.web.sys.service.SysUserService;
...
public class LoginController {
	...
	public @ResponseBody Map<String, Object> checkLogin(String username,
		...
		scode = "1233";//需要启动验证码时，请删除此行代码taosq
		code = scode.toString();//需要启动验证码时，请删除此行代码taosq
