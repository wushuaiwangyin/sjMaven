...
public class SubjectType extends BaseEntity {
	...
	@Id
	@SequenceGenerator(name="Any",sequenceName="subject_type_seq")
	private	Long	id;			//﻿编号
	private	String	name;			//名称
	private	Long	parentId;			//上一级分类
	private	Long	sort;			//序号
	private	String	description;			//描述
	private	Long	dbSource;			//数据源
	...
	public void setDbSource(Long dbSource){
		this.set("dbSource",dbSource);
	}

	public Long getDbSource(){
		return this.getLong("dbSource");
	}
