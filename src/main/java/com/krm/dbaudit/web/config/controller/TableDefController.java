...
import com.krm.dbaudit.web.config.service.TableDefService;
...
public class TableDefController extends BaseController {
	...
	* @return 模块html
	 */
	@RequestMapping
	public String totableDef(Model model){
	...
	* @return
	...
	public String list(@RequestParam Map<String, Object> params,Model model){
		PageInfo<TableDef> page = tableDefService.findPageInfo(params);
		model.addAttribute("page", page);
		return "tableDef/tableDef-list";
	}
	...
	* @return
	...
	public @ResponseBody Integer save(@ModelAttribute TableDef tableDef){
		return tableDefService.saveTableDef(tableDef);
	}
	...
	* @return
	...
	public @ResponseBody Integer del(Long id){
		return tableDefService.deleteTableDef(id);
	}
	...
	* @return
	...
	public @ResponseBody Integer dels(@RequestParam(value = "ids[]") Long[] ids){
		return tableDefService.deleteTableDef(ids);
	}
	...
	* @return
	...
	public String layer(Long id,@PathVariable String mode, Model model){
		...
		if(StringUtils.equals("edit", mode)){
			tableDef = tableDefService.selectByPrimaryKey(id);
		...
		return mode.equals("detail")?"tableDef/tableDef-detail":"tableDef/tableDef-save";
	}
