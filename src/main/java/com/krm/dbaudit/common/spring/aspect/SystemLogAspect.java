package com.krm.dbaudit.common.spring.aspect;
...
import com.krm.dbaudit.common.spring.annotation.Log;
...
public class SystemLogAspect {
	...
	@Pointcut("@annotation(com.krm.dbaudit.common.spring.annotation.Log)")
	public void accessAspect() {
	}
	
	@Pointcut("execution(* com.krm.dbaudit.web..*Service.*(..))")
