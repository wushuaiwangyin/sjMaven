package com.krm.dbaudit.common.mybatis.provider;
...
import com.krm.dbaudit.common.mybatis.EntityHelper;
...
public class CommonSqlProvider extends BaseProvider{
	...
	public String findEntityListByDataScope(final Map<String, Object> params){
		...
		return new SQL(){{
            ...
            com.krm.dbaudit.common.mybatis.EntityHelper.EntityTable entityTable = EntityHelper.getEntityTable(entityClass);
            SELECT(com.krm.dbaudit.common.mybatis.EntityHelper.getAllColumns(entityClass));
